...
export default class Preloader extends Phaser.Scene
{
	...
	{	
		...
		this.load.audio(EnvironmentSoundEffectKeys.LavaballThrow1, 'game-assets/sound-effects/environment/lavaball-throw-1.mp3')
		...
		this.load.audio(PlayerSoundEffectKeys.PlayerFireballThrow1, 'game-assets/sound-effects/players/player-fireball-throw-1.mp3')
		this.load.audio(PlayerSoundEffectKeys.PlayerFireballBurn1, 'game-assets/sound-effects/players/player-fireball-burn-1.mp3')
